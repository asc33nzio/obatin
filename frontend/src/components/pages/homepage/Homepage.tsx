...
import { Body, Container, NewSection, Fitur, FiturContainer, Imagecontainer, Title, ProductCard, Bold, Smallfont, Content} from '../../../styles/homepage/Homepage.styles';
                        ...
                        <Container>
                            {Product.map((product, i) => {
                                    ...
                                    <ProductCard key={i}>
                                        ...
                                        <p>{product.price}</p>
                                        <CustomButton $width='90px' $height='32px' content='Add to Cart' $fontSize='12px'/>
                                    </ProductCard>);
                                    })}
                        </Container>
                    </NewSection>
