...
//     const originalValue = doctorInfo?.birthDate;
...
//     try {
//       const patchProfileUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL}/users/${doctorInfo?.aid}`;
...
//       const userDetailUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL}/users/${doctorInfo?.aid}`;
...
//                         : doctorInfo?.birthDate && date instanceof Date
//                           ? moment(doctorInfo?.birthDate).format(
//                               'dddd, Do MMMM YYYY',
//                             )
//                           : '-'}
//                     </span>
...
//           {doctorInfo?.addresses?.map((address, index) => {
...
//                 isMainAddress={doctorInfo?.activeAddressId === address.id}
//                 alias={address.alias}
//                 details={fullAddress}
//               />
//             );
